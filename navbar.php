...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=candidate" class="nav-item nav-candidate"><span class='icon-field'><i class="fa fa-user-tie"></i></span> Candidate</a>	
				<!-- c<a href="index.php?page=vacancy" class="nav-item nav-vacancy"><span class='icon-field'><i class="fa fa-list-alt"></i></span> Vacancy</a>	 -->
